# defmodule Rocket.Subscription do
#   @moduledoc """
#   This module manages subscritioins
#   """
#
#   use Retry
#   alias Rocket.{Config, Response}
#
...
#
#     request(fn ->
#       HTTPoison.post("#{@base_url}#{@endpoint}:batchAdd", body |> Jason.encode!(), Config.new())
#     end)
#   end
#
#   @endpoint "/v1"
...
#
#     request(fn ->
#       HTTPoison.post(url, body |> Jason.encode!(), Config.new())
#     end)
#   end
#
#   @endpoint "/v1"
...
#       func.()
#     after
#       result -> Response.parse_result(result)
#     else
#       error -> error
#     end
#   end
